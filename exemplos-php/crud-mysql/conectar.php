...
function incluir($nome, $email, $cpf, $sexo, $escolaridade){
    $con = conectar();
    $sql = "insert into pessoa(nome, email, cpf, sexo, escolaridade) values('$nome','$email','$cpf', '$sexo','$escolaridade')";
...
function listar(){
    $con = conectar();
    $sql = "select id, nome, email, cpf, sexo, escolaridade from pessoa";
